          ...
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              <h2 className="font-semibold text-4xl text-gray-700">
                Таун Мастер - A beautiful extension for Tailwind CSS.
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-gray-600">
                Таун Мастер is Free and Open Source. It does not change or add
                  ...
                  <div className="relative flex flex-col mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-gray-600">
                        Таун Мастер comes with a huge number of Fully Coded CSS
                        components.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="relative flex flex-col min-w-0">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-gray-600">
                        ...
                        easy is to to work with Таун Мастер.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="justify-center text-center flex flex-wrap mt-24">
          <div className="w-full md:w-6/12 px-12 md:px-4">
            ...
            <p className="text-lg leading-relaxed mt-4 mb-4 text-gray-600">
              Таун Мастер is a completly new product built using our past
