...
export default function Sidebar({ sideBarOpen }) {
    let match = useRouteMatch("/personal/company");
    ...
    return (
        <div
            className={
                `flex-col w-full md:w-1/3 lg:w-84 fixed md:top-0 md:left-0 h-screen overflow-y-auto lg:flex border-r z-30 bg-white` +
                (sideBarOpen ? `` : ` hidden`)
            }
            id="main-nav"
        >
            ...
            <div className="flex flex-col overflow-y-auto flex-grow">
                <div className="mb-4 flex-grow pt-6">
                    {currentUser.company ? (
                        <div className="w-full items-center cursor-pointer">
                            <NavLink
                                to={`/personal/company`}
                                className={`py-4 block flex hover:bg-gray-100 w-full px-4`}
                            ...
                            {match ? (
                                <div className="pl-2 text-sm pb-4">
                                    <NavLink
                                        ...
                                        className={`py-2 block flex hover:bg-gray-100 w-full px-4`}
                                        activeClassName="bg-gray-100 font-semibold"
                                    >
                                        <div className="h-6 w-6 fill-current mr-2">
                                            <AccountingSidebarIcon />
